# Generated by Django 2.1.4 on 2019-06-01 15:08
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('ServiceCore', '0009_auto_20190512_0020'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='group',
            name='tasks',
            field=models.ManyToManyField(blank=True, related_name='tasks', to='ServiceCore.Task'),
        ),
        migrations.AlterField(
            model_name='group',
            name='users',
